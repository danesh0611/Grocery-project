...
def show_admin_menu():
   ...
   # Load the music file
    pygame.mixer.music.load(r"F:\Users\babu\Desktop\project\music.mp3")
...
# Play the music
    ...
    image = PhotoImage(file=r"F:\users\babu\Desktop\project\bill.PNG")
    customer_username_label= ttk.Label(view_details_frame, text="username ")
...
# UI elements for the Edit Email frame
    email_label = ttk.Label(edit_email_frame, text="Enter your email address:")
    ...
    entered_otp_label = ttk.Label(edit_email_frame, text="Enter OTP:")
    ...
    new_email_label = ttk.Label(edit_email_frame, text="Enter new email:")
    ...
    send_otp_button = ttk.Button(edit_email_frame, text="Send OTP", command=send_otp)
    send_otp_button.grid(row=5, columnspan=2, pady=10)

    verify_otp_button = ttk.Button(edit_email_frame, text="Verify and Update Email", command=edit_email)
