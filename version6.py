...
bg_image = tk.PhotoImage(file=r"E:\Users\babu\Desktop\project\intro.png")
bg_label = tk.Label(root, image=bg_image)
bg_label.place(relwidth=1, relheight=1)
pygame.init()

# Load the music file
pygame.mixer.music.load(r"E:\Users\babu\Desktop\project\welcome.mp3")
# Play the music
...
def forgot_password():
    def reset():
        ...
        for i in result:
            if i[0] == customer_username:
                cursor.execute("SELECT security_question FROM credentials WHERE username = %s", (customer_username,))
                result1 = cursor.fetchall()
                for j in result1:
                    if j[0] == sec1_question:
                        
                        if len(customer_password) < 8 or not any(char.isupper() for char in customer_password) or not any(char.isdigit() for char in customer_password) or not any(char.isalnum() or char in '!@#$%^&*()_+' for char in customer_password):
                        ...
                        messagebox.showinfo("Error", "Incorrect security question answer.")
                        return
    ...
    sec1_label = tk.Label(root2, text="enter your school studied or enter your favourite fruit")
...
def show_admin_menu():
   ...
   # Load the music file
    pygame.mixer.music.load(r"E:\Users\babu\Desktop\project\music.mp3")
   ...
   # Play the music
    ...
    image = PhotoImage(file=r"E:\users\babu\Desktop\project\add entry.png")
...
# Set the background color for the Treeview
    ...
    image = PhotoImage(file=r"E:\users\babu\Desktop\project\remove.png")
...
# Create widgets for modifying items
    ...
    image = PhotoImage(file=r"E:\users\babu\Desktop\project\modify.png")
...
# Add a label to display the image
    ...
    image = PhotoImage(file=r"E:\users\babu\Desktop\project\profit.png")
...
# Add a label to display the image
    ...
    image = PhotoImage(file=r"E:\users\babu\Desktop\project\graph.png")
...
# Add a label to display the image
    ...
    image = PhotoImage(file=r"E:\users\babu\Desktop\project\users.png")
...
# Initialize the Tkinter window
    ...
    image = PhotoImage(file=r"E:\users\babu\Desktop\project\bill.PNG")
...
# Function to finalize the bill
    def finalize_bill():
        ...
        if not customer_phone_number or not customer_address:
            ...
            # Load the music file
            pygame.mixer.music.load(r"E:\Users\babu\Desktop\project\confirm.mp3")
...
# Load the music file
    pygame.mixer.music.load(r"E:\Users\babu\Desktop\project\success.mp3")
...
# Play the music
    ...
    image = PhotoImage(file=r"E:\users\babu\Desktop\project\bill.PNG")
    view_details_Button = ttk.Button(view_details_frame, text="view details", command=view_details)
    view_details_Button.grid(row=0, column=0, pady=10)
    customer_email_label = ttk.Label(view_details_frame, text="Email:")
    customer_email_label.grid(row=1, column=0, padx=10, pady=5)

    customer_password_label = ttk.Label(view_details_frame, text="Password:")
    customer_password_label.grid(row=2, column=0, padx=10, pady=5)
